...
exports.LastPosition = void 0;
// models/LastPosition.ts
const mongoose_1 = __importStar(require("mongoose"));
const lastPositionSchema = new mongoose_1.Schema({
    ...
    carrier: { type: String },
    trama: { type: String },
    scan: { type: mongoose_1.Schema.Types.Mixed },
...
exports.LastPosition = mongoose_1.default.model('LastPosition', lastPositionSchema);
